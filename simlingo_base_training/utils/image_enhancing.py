"""Image enhancement utilities for improving visual quality.

This module provides functions for enhancing camera images to improve
visibility and model performance in challenging lighting conditions.

Key Functions:
    - histogram_equalization: Global contrast enhancement
    - clahe: Contrast-Limited Adaptive Histogram Equalization

These methods can help with:
    - Low light conditions
    - Overexposed images
    - Improving feature visibility
    - Data augmentation

Usage is optional and controlled by config flag 'image_enhancing'.
...
def histogram_equalization(rgb_image):
    ...
    Works by equalizing the histogram of the Y (luminance) channel in YUV space.

    Args:
        rgb_image: RGB image array, shape [H, W, 3].

    Returns:
        numpy.ndarray: Contrast-enhanced RGB image, same shape as input.

    Note:
        Works best for images with narrow intensity distributions.
        May over-enhance images with good initial contrast.
    """
